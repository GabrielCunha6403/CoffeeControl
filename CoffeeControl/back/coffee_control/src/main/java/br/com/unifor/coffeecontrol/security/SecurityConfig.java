...
////    private AuthenticationManager authenticationManager = authenticationConfiguration.getAuthenticationManager();
////
...
//                        .requestMatchers("/solicitations/**","/products/**","/contributions/**","/auth/**").permitAll()
